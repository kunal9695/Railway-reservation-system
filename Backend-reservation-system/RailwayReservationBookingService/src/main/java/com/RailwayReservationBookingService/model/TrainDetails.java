...
public class TrainDetails {
	...
	@NotNull
	@Min(value = 5, message = "Train name should be minimum of 5 characters")
	private String trainName;

	@NotNull
	@Min(value = 2, message = "Source Station should be minimum of 2 characters")
	private String sourceStation;

	@NotNull
	@Min(value = 2, message = "Destination Station should be minimum of 2 characters")
	...
	@NotNull
	@Max(value = 7, message = "Departure Time should be maximum of 7 characters")
