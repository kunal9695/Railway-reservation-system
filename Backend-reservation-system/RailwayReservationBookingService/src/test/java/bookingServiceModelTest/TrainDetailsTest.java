...
public class TrainDetailsTest {
	...
	@Test
	void testToString() {
			String a = "TrainDetails [trainNo=" +t1.getTrainNo() + ", trainName=" + t1.getTrainName() + ", sourceStation=" + t1.getSourceStation()
					+ ", destinationStation=" + t1.getDestinationStation() + ", arrivalTime=" + t1.getArrivalTime() + ", deptTime="
					+ t1.getDeptTime() + ", duration=" + t1.getDuration() + ", noOfSeats=" + t1.getNoOfSeats() + ", firstClassACFare="
					+ t1.getFirstClassACFare() + ", twoTierAcFare=" + t1.getTwoTierAcFare() + ", threeTierAcFare=" + t1.getThreeTierAcFare()
					+ ", sleeperFare=" + t1.getSleeperFare() + "]";
					
		    String b = "TrainDetails [trainNo=" +12246 + ", trainName=" + "Duronto Express"  + ", sourceStation=" + "Kolkata"
			+ ", destinationStation=" + "Bengaluru" + ", arrivalTime=" + "16:00" + ", deptTime="
			+ "11:15"  + ", duration=" + "28 hours 45 minutes" + ", noOfSeats=" + 490 + ", firstClassACFare="
			+ 4000 + ", twoTierAcFare=" + 3500 + ", threeTierAcFare=" + 3000
			+ ", sleeperFare=" + 2500 + "]";
		    assertEquals(a,b);
